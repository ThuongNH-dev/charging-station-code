...
const KPIChart = ({ kpiData = {}, timeChartData = [] }) => {
  const { totalRevenue = 0, totalSessions = 0, avgUsage = 0, totalStations = 0 } = kpiData;
  ...
  const statusData = [
    { name: 'Hoạt động', value: Math.floor(totalStations * 0.8), color: '#34A853' },
    { name: 'Bảo trì', value: Math.floor(totalStations * 0.15), color: '#FBBC05' },
    { name: 'Ngừng hoạt động', value: Math.floor(totalStations * 0.05), color: '#EA4335' }
  ];
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
        {/* Biểu đồ cột KPI */}
        <div>
          <h5 style={{ textAlign: 'center', marginBottom: '15px', color: '#333' }}>
            Chỉ số chính
          </h5>
